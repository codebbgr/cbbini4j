 ...
 */
/**
 * Changelog ========= 04/04/2020 (gmoralis) - Provide api to manage custom user data per ini file
 * (jetbrains patch) 03/04/2020 (gmoralis) - Initial commit from ini4j project
 */
