 ...
 * correspondingly 03/04/2020 (gmoralis) - renamed remove(obj,obj) function to removeObj(obj,obj)
 * 03/04/2020 (gmoralis) - Initial commit from ini4j project
 */
package gr.cobebb.cbbini4j;

import gr.codebb.cbbini4j.spi.AbstractBeanInvocationHandler;
import gr.codebb.cbbini4j.spi.BeanTool;
...
public class BasicProfile extends CommonMultiMap<String, Profile.Section> implements Profile {
  ...
  @Override
  public String removeObj(Object sectionName, Object optionName) {
    Section sec = get(sectionName);
